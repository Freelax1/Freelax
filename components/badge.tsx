...
const STATUS_CLASSES: Record<string, string> = {
  outside_ir35:  'bg-green-100 text-green-900 border border-green-200',
  inside_ir35:   'bg-red-100 text-red-900 border border-red-200',
  needs_review:  'bg-amber-100 text-amber-900 border border-amber-200',
  ...
  paused:        'bg-amber-100 text-amber-900 border border-amber-200',
  archived:      'bg-gray-100 text-gray-700 border border-gray-200',
  on_hold:       'bg-amber-100 text-amber-900 border border-amber-200',
  ...
  declined:      'bg-red-100 text-red-900 border border-red-200',
