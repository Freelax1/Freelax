...
import { AuthWordmark, AuthHeading, AuthError, AuthStateHeading, AuthStateIcon } from '@/components/auth-ui'
...
export default function ForgotPasswordPage() {
    ...
    return (
      <div className="text-center py-3">
        ...
        <p className="text-sm leading-relaxed m-0 text-text-secondary">
          If an account exists for <strong className="text-text-primary">{email}</strong>, you&apos;ll receive a reset link shortly.
        </p>
        <p className="text-sm leading-relaxed mt-2 mb-0 text-text-muted">
  ...
  return (
    <>
      ...
      <Link
        href="/auth/login"
        className="text-xs text-text-secondary no-underline inline-block mb-5 font-medium hover:text-text-primary"
      >
        ← Back to sign in
      </Link>
