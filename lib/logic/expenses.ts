...
export const CATEGORY_COLORS: Record<string, string> = {
  office_supplies:   'bg-forest-50 text-forest-700',
  travel:            'bg-warning-50 text-warning-700',
  software:          'bg-forest-100 text-forest-800',
  phone_internet:    'bg-forest-50 text-forest-600',
  ...
  training:          'bg-warning-50 text-warning-800',
